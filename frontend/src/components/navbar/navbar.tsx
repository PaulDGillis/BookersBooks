const Navbar = (props: { handleUpload: () => void; logout: () => void }) => {
  return (
    <>
      <nav
        className="py-2 px-3 justify-between flex-no-wrap relative flex w-full bg-[#FBFBFB] shadow-md shadow-black/5 dark:bg-neutral-600 dark:shadow-black/10"
        data-te-navbar-ref
      >
        <div
