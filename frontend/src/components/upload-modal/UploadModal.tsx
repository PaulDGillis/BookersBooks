...
>((props, ref) => {
  ...
  return (
    <div className="fixed z-[-1] inset-0 bg-black/54" ref={ref} {...other} />
  );
});
...
const UploadModal = (props: { open: boolean; handleClose: () => void }) => {
  ...
  return (
    <>
      ...
      >
        <div className="w-5/6 rounded-xl py-9 pl-4 pr-6 bg-white shadow-[0_2px_24px_#000]">
          <label
            htmlFor="formFile"
            className="mb-2 inline-block text-neutral-700 dark:text-neutral-200"
          >
            Upload file.epub to add to library.
          </label>
          <input
